...
interface MovieRetrofitInterface {
    ...
    suspend fun getNowPlaying() : RequestResult<MoviePage?>

    @GET("movie/popular?")
    suspend fun getPopular(): RequestResult<MoviePage?>
    ...
    @GET("movie/top_rated?")
    suspend fun getTopRated(): RequestResult<MoviePage?>

    @GET("movie/upcoming?")
    suspend fun getUpcoming(): RequestResult<MoviePage?>
